...
async function forgotPassword () {
  const r1 = await api.forgotPassword('steve')
  console.log(r1)
  const code = r1.message
  const r2 = await api.resetPassword(code, 'xyz')
  console.log(r2)
  const r3 = await api.login('steve', 'xyz')
  console.log(r3)
  await logout()
  const r4 = await api.forgotPassword('steve')
  console.log(r4)
  const r5 = await api.resetPassword(r4.message, 'xyz')
  console.log(r5)
}
